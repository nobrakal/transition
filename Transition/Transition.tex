...
La garde Azov, de son nom la \emph{Anikaï} est principalement constituée de cyborgs. Ces être ont souvent des armes à la place des bras, ainsi qu'un microprocesseur implanté dans le cerveau. Il sont redoutables.
\begin{figure}[H]
    \centering
    \def\svgwidth{15em}
